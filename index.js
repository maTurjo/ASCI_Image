...
const canvasV = document.getElementById("c2");
...
let videoPixel;
setInterval(() => {
    ctx2 === null || ctx2 === void 0 ? void 0 : ctx2.drawImage(vid, 0, 0, 320, 240);
    videoPixel = ctx2 === null || ctx2 === void 0 ? void 0 : ctx2.getImageData(0, 0, canvasV.width, canvasV.height);
    let symbolCol = "";
    if (videoPixel) {
        for (let i = 0; i < (videoPixel === null || videoPixel === void 0 ? void 0 : videoPixel.height); i = i + 2) {
